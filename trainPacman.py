...
class TestTraining:
    ...
    def plot_rewards(self, i , arr):
        ...
        fig.write_image(f"750_2_1{i}.png")
        ...
        tig.write_image(f"750_2_2{i}.png")
        ...
        sag.write_image(f"750_2_3{i}.png")
...
if __name__ == "__main__":
    model_path = "mspacman_dqn_model_500.pth"
    #mspacman_dqn_model_1000_1
    mode_path_save = "mspacman_dqn_model_750_2.pth"
