...
class TestTraining:
    ...
    def run(self):
        ...
        for episode in range(self.episodes):
            ...
            if (episode + 1) % 100 == 0:
                ...
                #self.plot_rewards((episode + 1) / 5 , self.rewards[-100:])
                print("Graph saved")
    ...
    def hyperparameter_search(self, param_grid):
        ...
        for params in param_grid:
            ...
            agent = TD3Agent(
                ...
                beta_frames=params['beta_frames']
            )
    ...
    def plot_rewards(self, i , arr):
        ...
        fig.write_image(f"750_f_1{i}.png")
        ...
        tig.write_image(f"750_f_2{i}.png")
        ...
        sag.write_image(f"750_f_3{i}.png")
...
if __name__ == "__main__":
    ...
    pacman = TestTraining('ALE/Pacman-v5', episodes=750, batch_size=128)
    
    best_params, best_reward = pacman.hyperparameter_search(param_grid)

    print(f"Best parameters found: {best_params} with an average reward of {best_reward}")

    pacman.save(f"best_model_{best_reward}.pth")
