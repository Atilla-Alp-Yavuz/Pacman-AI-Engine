    ...
    def run(self):
        ...
        for episode in range(self.episodes):
            ...
            if (episode + 1) % 100 == 0:
                ...
                #self.plot_rewards((episode + 1) / 5 , self.rewards[-10:])
                print("Graph saved")
...
if __name__ == "__main__":
    model_path = "mspacman_dqn_model_1000.pth"
    pacman = TestTraining('ALE/Pacman-v5', episodes=1000, batch_size=128)
