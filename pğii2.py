...
class TestTraining:
    ...
    #NO REWARD EARNED PUNISHMENT EKLE
    #GUIDE TS AO THE NEAREST POWER PILL AND BRING THEM BACK TO CENTER TO MAXİMIZE THE POSSİBILITY OF EATING GHOST
    def pretrain(self, total_reward , factor,select):
    ...
    def run(self):
        ...
        for t in range(pretrain_volume):
            ...
            while not done:
                ...
                action = self.pretrain(total_reward , factor , select)
